...
hidden if the `qt-json-editor_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `qt-json-editor_DEVELOPER_MODE` to the configure
